...
(2, 'Szarlotka', 'Na kruchym cieœcie', 40.00, 1),
(3, 'Brownie', 'Mocno czekoladowe', 50.00, 1);
SET IDENTITY_INSERT Ciasta OFF;

-- 1. NAJPIERW zdejmujemy blokadê (usuwamy kolumnê wyliczan¹)
...
-- 2. TERAZ zmieniamy typy danych (nie ma ju¿ zale¿noœci, wiêc SQL na to pozwoli)
...
-- 3. NA KONIEC przywracamy kolumnê wyliczan¹ na swoje miejsce
...
(103, 1, '2024-05-22 09:15:00', '2024-05-27 12:00:00', 'Zakoñczone', 0.05, 210.00),
...
(108, 2, '2024-05-27 10:00:00', '2024-05-29 15:00:00', 'Zakoñczone', 0.00, 99.99);
SET IDENTITY_INSERT Zamowienia OFF;


-- WSTAWIANIE POZYCJI ZAMÓWIENIA
SET IDENTITY_INSERT PozycjeZamowienia ON;
-- Dodaliœmy 'TypPozycji' do listy kolumn i odpowiednie wartoœci do wierszy
